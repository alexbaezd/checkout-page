...
function vanillaSelectBox(domSelector, options) {
  ...
  this.getCssArray = function (selector) {
    ...
    if (selector === ".vsb-main button") {
      cssArray = [
        { key: "min-width", value: "100%" },
        { key: "border-radius", value: "10px" },
        { key: "width", value: "100%" },
        { key: "text-align", value: "left" },
        { key: "z-index", value: "1" },
        { key: "line-height", value: "20px" },
        { key: "font-size", value: "0.9rem" },
        { key: "padding", value: "9px 12px" },
        { key: "margin-top", value: "9px" },
      ];
    }
  ...
  this.init = function () {
    ...
    if (self.isRemote && self.onInitSize > 0) {
      self.onSearch("", self.onInitSize).then(function (data) {
...
vanillaSelectBox.prototype.remoteSearchIntegrate = function (data) {
  ...
  if (data == null || data.length == 0) {
    ...
    let already = Array.prototype.slice
      .call(self.root.options)
      .map(function (x) {
        return x.value;
      });
    if (already.length > 0) {
